...
Source: a [Claude Design](https://claude.ai/design) handoff bundle (2026-09-01), stored as-is in this directory for reference. Open `Smartwatch System.dc.html` to browse the original mockups.
